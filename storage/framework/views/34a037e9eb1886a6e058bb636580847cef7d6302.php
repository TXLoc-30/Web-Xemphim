    ...
    <div class="container">
        ...
        <div class="row moviedetail">
            <div class="col-md-4 text-center">
                <img class="img-thumbnail" src="<?php echo e(asset('storage/poster/'.$movie->poster_image)); ?>">
            </div>
            <div class="col-md-4">
                                                    ...
                                                    <div class="form">
                                                        <form action="<?php echo e(route('user.buyMovie',$movie->id)); ?>" method="get">
                                                            ...
                                                            <h2 class="text-center">VÍ:
                                                                <?php if($wallet): ?>
                                                                <b><?php echo e(number_format(round($wallet->money)).'đ'); ?></b>
                                                                <?php else: ?>
                                                                <b>0đ</b>
                                                                <?php endif; ?>
                                                            </h2><br>
                        ...
                        <div class="item">
                            <div class="w3l-movie-gride-agile w3l-movie-gride-agile1">
                                <a href="<?php echo e(route('user.movie',$item->id)); ?>" title="<?php echo e($item->vie_name.' ('.$item->eng_name.')'); ?>" class="hvr-shutter-out-horizontal">
                                    <img src="<?php echo e(asset('storage/poster/'.$item->poster_image)); ?>" title="<?php echo e($item->vie_name.' ('.$item->eng_name.')'); ?>" class="img-responsive" alt=" " />
...
<?php echo $__env->make('user.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp2025\htdocs\Web-Xemphim-master\resources\views/user/detailmovie.blade.php ENDPATH**/ ?>